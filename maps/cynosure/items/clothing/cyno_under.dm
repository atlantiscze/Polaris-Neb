...
/obj/item/clothing/under/rank/pilot1
	...
	icon_state = "pilot1"
	// worn_state = "pilot1" //NEBFIX
	// item_icons = list(slot_w_uniform_str = 'maps/cynosure/icons/mob/cyno_under.dmi') //NEBFIX
...
/obj/item/clothing/under/rank/pilot2
	...
	icon_state = "pilot2"
	// worn_state = "pilot2" //NEBFIX
	// rolled_down = 0 //NEBFIX
	// rolled_sleeves = 0 //NEBFIX
	// item_icons = list(slot_w_uniform_str = 'maps/cynosure/icons/mob/cyno_under.dmi') //NEBFIX
	icon = 'maps/cynosure/icons/obj/cyno_uniforms.dmi'
	sprite_sheets = list(
			"Teshari" = 'maps/cynosure/icons/mob/species/teshari/cyno_uniform.dmi'
