...
/obj/structure/closet/secure_closet/explorer/Initialize()
	if(prob(50))
		starts_with += /obj/item/backpack/rucksack
	else
		starts_with += /obj/item/backpack/satchel/norm
	if(prob(75))
...
/obj/structure/closet/secure_closet/xenofauna
	...
	starts_with = list(
		...
		/obj/item/radio,
		/obj/item/cataloguer,
		/obj/item/backpack/satchel/norm,
...
/obj/structure/closet/secure_closet/sar
	...
	starts_with = list(
		/obj/item/backpack/dufflebag/emt,
