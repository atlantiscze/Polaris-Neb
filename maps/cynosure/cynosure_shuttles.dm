...
/datum/shuttle/autodock/ferry/arrivals/cynosure
	...
	dock_target = "arrivals_shuttle" // NEBFIX
...
/obj/effect/shuttle_landmark/cynosure/arrivals_station
	...
	// base_turf = /turf/floor/concrete/sif/planetuse //NEBFIX

// Cargo shuttle.

/datum/shuttle/autodock/ferry/supply/cargo
	name = "Supply"
	// location = FERRY_LOCATION_OFFSITE // NEBFIX
	warmup_time = 10
	shuttle_area = /area/shuttle/supply_shuttle
	waypoint_offsite = "supply_offsite"
	waypoint_station = "supply_station"
	dock_target = "supply_shuttle" // NEBFIX
	ceiling_type = /turf/floor/reinforced
...
/datum/shuttle/autodock/multi/centcom
	...
	dock_target = "centcom_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, Transport Shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, Transport Shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/administration
	...
	dock_target = "admin_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, Administration Shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, Administration Shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/response
	...
	// can_cloak = TRUE //NEBFIX
	// cloaked = FALSE //NEBFIX
	warmup_time = 5
	...
	dock_target = "response_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, the Emergency Response Team's shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, the Emergency Response Team's shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/merchant
	...
	dock_target = "trade_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, Beruang is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, Beruang is departing Cynosure Station." //NEBFIX
...
/obj/machinery/computer/shuttle_control/multi/ninja
	...
	shuttle_tag = "Ninja"
	//req_access = list(access_syndicate) //NEBFIX
...
/datum/shuttle/autodock/multi/ninja
	...
	dock_target = "ninja_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, unknown shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, unknown shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/heist
	...
	dock_target = "skipjack_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, unknown shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, unknown shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/mercenary
	...
	dock_target = "merc_shuttle" // NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, unknown shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, unknown shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/multi/mercenary_elite
	...
	dock_target = "merc_elite_shuttle" //NEBFIX
	ceiling_type = /turf/floor/reinforced
	// announcer = "Automated Traffic Control" //NEBFIX
	// arrival_message = "Attention, unknown shuttle is approaching Cynosure Station." //NEBFIX
	// departure_message = "Attention, unknown shuttle is departing Cynosure Station." //NEBFIX
...
/datum/shuttle/autodock/ferry/emergency/centcom
	...
	waypoint_offsite = "escape_offsite"
	waypoint_station = "escape_station"
	landmark_transition = "escape_transit";
	dock_target = "escape_shuttle" // NEBFIX
	ceiling_type = /turf/floor/reinforced
	// move_time = SHUTTLE_TRANSIT_DURATION_RETURN //NEBFIX
...
/* //NEBFIX - Last entry in previous define was:
...
/datum/shuttle/autodock/ferry/escape_pod/large_escape_pod1
	...
	waypoint_station = "large_escape_pod1_station"
	waypoint_offsite = "large_escape_pod1_offsite"
	landmark_transition = "large_escape_pod1_transit"
	dock_target = "large_escape_pod_1" //NEBFIX
	// move_time = SHUTTLE_TRANSIT_DURATION_RETURN //NEBFIX
...
/obj/effect/shuttle_landmark/cynosure/large_escape_pod1/transit
	...
	//landmark_flags = LANDMARK_CREATES_SAFE_SITE //NEBFIX

// Large Escape Pod 2
/datum/shuttle/autodock/ferry/escape_pod/large_escape_pod2
	name = "Large Escape Pod 2"
	// location = FERRY_LOCATION_STATION // NEBFIX
	warmup_time = 0
	shuttle_area = /area/shuttle/large_escape_pod2/station
	waypoint_station = "large_escape_pod2_station"
	waypoint_offsite = "large_escape_pod2_offsite"
	landmark_transition = "large_escape_pod2_transit"
	dock_target = "large_escape_pod_2" // NEBFIX
	// move_time = SHUTTLE_TRANSIT_DURATION_RETURN //NEBFIX
...
/datum/shuttle/autodock/overmap/explorer_shuttle
	...
	dock_target = "expshuttle_docker"  //NEBFIX
...
/obj/effect/overmap/visitable/ship/landable/explorer_shuttle
	...
	// scanner_desc = "A Wulf Vagabond-class short-range expedition shuttle. It is broadcasting NanoTrasen identification codes: VIR-472-320377 - NTC Calvera." //NEBFIX
	vessel_mass = 2000
