...
/area/surface/station/maintenance
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_STATION_AREA
...
/area/surface/station/medical/etc
	...
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT | AREA_FLAG_IS_STATION_AREA //Trust me.
...
/area/surface/station/medical/surgery
	...
	icon_state = "surgery"
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT | AREA_FLAG_IS_STATION_AREA //This WOULD become a filth pit
...
/area/surface/station/quartermaster/delivery
	...
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT | AREA_FLAG_IS_STATION_AREA //So trash doesn't pile up too hard.
...
/area/surface/station/rnd/xenobiology/xenofauna
	name = "\improper Research - Xenofauna Lab"
	icon_state = "xeno_f_lab"
...
/area/syndicate_station/planet
	...
	dynamic_lighting = 1
	icon_state = "shuttlered"
	base_turf = /turf/floor/natural/grass
