// NEBFIX - Added here, needs to be gone through and adjusted as needed
/area/centcom/command
	name = "Centcom - Command"
...
/area/surface/outside
	// ambience = AMBIENCE_SIF //NEBFIX
	always_unpowered = TRUE
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT
	// outdoors = OUTDOORS_YES //NEBFIX
	// area_blurb = "The cold Sivian air blows around you. The occasional animal call can be heard in the distance. Far above you, the sky looms, sometimes a passing bird can be seen." //NEBFIX
	// area_blurb_category = "outside" //NEBFIX
...
/area/surface/outside/river
	name = "River"
	icon_state = "bluenew"
	// area_blurb = "Cold water flows along this river, winding its way through the countryside." //NEBFIX
	// area_blurb_category = "river" //NEBFIX
...
/area/surface/cave
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT
	always_unpowered = TRUE
	// area_blurb = "Cold, still air sits in these dark and dusty cavern tunnels." //NEBFIX
	// area_blurb_category = "caves" //NEBFIX
...
/area/surface/station
	// ambience = AMBIENCE_GENERIC //NEBFIX
	// outdoors = OUTDOORS_NO //NEBFIX
...
/area/surface/station/arrivals
	// forbid_events = TRUE //NEBFIX
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/floor/outdoors/dirt/sif/planetuse //NEBFIX
...
/area/surface/station/maintenance/substation
	...
	sound_env = SMALL_ENCLOSED
	// ambience = AMBIENCE_SUBSTATION //NEBFIX
...
/area/surface/station/chapel
	// ambience = AMBIENCE_CHAPEL //NEBFIX
	icon_state = "chapel"
...
/area/surface/station/crew_quarters/sleep/Dorm_1
	...
	icon_state = "Sleep"
	// holomap_color = HOLOMAP_AREACOLOR_DORMS //NEBFIX
...
/area/surface/station/crew_quarters/pool
	name = "\improper Pool"
	icon_state = "pool"
	// area_blurb = "The smell of warm pool water sits in this room. The windows are slightly misted from condensation." //NEBFIX
...
/area/surface/station/janitor/
	...
	icon_state = "janitor"
	// area_blurb = "A strong, concentrated smell of many cleaning supplies sit within this room." //NEBFIX
	// area_blurb_category = "janitor" //NEBFIX
...
/area/surface/station/park
	...
	// area_blurb = "Sounds echo slightly within this large and open atrium, Sif's sky can be seen above through the curved glass roof windows." //NEBFIX
	// area_blurb_category = "atrium" //NEBFIX
...
/area/surface/station/vault
	...
	// ambience = AMBIENCE_HIGHSEC //NEBFIX
	holomap_color = HOLOMAP_AREACOLOR_COMMAND
...
/area/surface/station/engineering/
	...
	// ambience = AMBIENCE_ENGINEERING //NEBFIX
	holomap_color = HOLOMAP_AREACOLOR_ENGINEERING
...
/area/surface/station/engineering/atmos
 	...
 	icon_state = "atmos"
 	sound_env = LARGE_ENCLOSED
	// ambience = AMBIENCE_ATMOS //NEBFIX
...
/area/surface/station/maintenance
	...
	// turf_initializer = new /datum/turf_initializer/maintenance() //NEBFIX
	// ambience = AMBIENCE_MAINTENANCE //NEBFIX
	// area_blurb = "Dark, tight, and filled with barely filtered air. Around you hisses compressed air through pipes, a buzz of electrical charge through wires, winding through damp maintenance corridors." //NEBFIX
	// area_blurb_category = "maintenance" //NEBFIX
...
/area/surface/station/medical/
	...
	icon_state = "medbay"
	// music = 'sound/ambience/signal.ogg' //NEBFIX
	holomap_color = HOLOMAP_AREACOLOR_MEDICAL
	// area_blurb = "The smells of a hospital waft through the air: strong sterilizing agents, various medicines, and sterile gloves. It's not a pleasant smell, but one you could grow to ignore." //NEBFIX
	// area_blurb_category = "medical" //NEBFIX
...
/area/surface/station/medical/etc
	...
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT //Trust me.
...
/area/surface/station/medical/psych
	...
	icon_state = "medbay3"
	// music = 'sound/ambience/signal.ogg' //NEBFIX
	// area_blurb = "With a carpeted floor and comfy furniture, this room has a warmer feeling compared to the sterility of the rest of the medical wing." //NEBFIX
	// area_blurb_category = "psych" //NEBFIX
...
/area/surface/station/medical/surgery
	...
	icon_state = "surgery"
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT //This WOULD become a filth pit
...
/area/surface/outside/station/roof
	name = "\improper Roof"
	icon_state = "dark128"
	// area_blurb = "The sivian wilds stretch out below you from the station's rooftops. Trees light the landscape with a soft blue glow." //NEBFIX
	// area_blurb_category = "roof" //NEBFIX
...
/area/surface/station/quartermaster/storage
	...
	icon_state = "quartstorage"
	sound_env = LARGE_ENCLOSED
	// area_blurb = "Scuff marks scar the floor from the movement of many crates." //NEBFIX
	// area_blurb_category = "cargo" //NEBFIX
...
/area/surface/station/quartermaster/delivery
	...
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_IS_NOT_PERSISTENT //So trash doesn't pile up too hard.
...
/area/surface/station/rnd/robotics
	...
	icon_state = "robotics"
	// area_blurb = "The scents of oil and machine lubricant fill the air in this workshop." //NEBFIX
	// area_blurb_category = "robotics" //NEBFIX
...
/area/shuttle/response_ship/sky
	...
	icon_state = "shuttlegrn"
	base_turf = /turf/floor/reinforced
	//base_turf = /turf/sky/west //NEBFIX

/area/shuttle/response_ship/sky_transit
	name = "in flight over sif"
	icon_state = "shuttlered"
	base_turf = /turf/floor/reinforced
	//base_turf = /turf/sky/moving/west //NEBFIX
...
/area/syndicate_station/sky
	...
	icon_state = "shuttlegrn"
	base_turf = /turf/floor/reinforced
	//base_turf = /turf/simulated/sky/west //NEBFIX

/area/syndicate_station/sky_transit
	name = "in flight over sif"
	icon_state = "shuttlered"
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/simulated/sky/moving/west //NEBFIX
...
/area/skipjack_station/sky
	...
	icon_state = "shuttlegrn"
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/simulated/sky/north //NEBFIX

/area/skipjack_station/sky_transit
	name = "in flight over sif"
	icon_state = "shuttlered"
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/simulated/sky/moving/north //NEBFIX
...
/area/ninja_dojo/sky
	...
	icon_state = "shuttlegrn"
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/simulated/sky/south //NEBFIX

/area/ninja_dojo/sky_transit
	name = "in flight over sif"
	icon_state = "shuttlered"
	base_turf = /turf/floor/reinforced
	// base_turf = /turf/simulated/sky/moving/south //NEBFIX
